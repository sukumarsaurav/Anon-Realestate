        ...
        {!showCtA ? (
          ...
          <div className="space-y-2">
            ...
            <a href={`https://wa.me/${waNumber}?text=${encodeURIComponent(waMsg)}`}
              ...
              className="flex items-center justify-center gap-2 w-full py-3.5 bg-whatsapp text-white font-semibold rounded-xl hover:bg-whatsapp-dark text-sm transition-colors">
