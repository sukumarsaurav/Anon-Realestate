      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl border border-gray-100 p-7">
            <div className="w-11 h-11 rounded-xl bg-gold-50 flex items-center justify-center mb-4"><Compass size={20} className="text-gold-600" /></div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-7">
            <div className="w-11 h-11 rounded-xl bg-gold-50 flex items-center justify-center mb-4"><Target size={20} className="text-gold-600" /></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {values.map(({ Icon, t, s }) => (
              <div key={t} className="bg-white rounded-2xl border border-gray-100 p-6">
                <div className="w-10 h-10 rounded-xl bg-gold-50 flex items-center justify-center mb-3"><Icon size={18} className="text-gold-600" /></div>
